...
{
    /// <summary>
    /// Класс фоновой задачи, которая проверяет состояние тех. работ в БД и оповещения по WebSocket
    /// </summary>
    public class WsMaintenanceStatusChecker : IHostedService, IDisposable
    {
        /// <summary>
        /// Экземляр логгера
        /// </summary>
        private readonly ILogger<WsMaintenanceStatusChecker> _logger;
        ...
        public WsMaintenanceStatusChecker(ILogger<WsMaintenanceStatusChecker> logger,
